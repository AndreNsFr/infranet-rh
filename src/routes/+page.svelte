...
<main>
    <section>
        <form on:submit={contato} method="post">
            <h1
                style="text-align: center; margin-top: 10px;
            margin-bottom:40px; font-size:30pt;"
            >
                Login
            </h1>
            ...
            <label required for="senha">Digite o sua senha:</label>
            <input
                type="password"
                name="senha"
                id="senha"
...
<style>
    ...
    section {
        ...
        border-radius: 15px;
        height: 600px;
        box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.705);
    }
